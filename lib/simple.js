...
export function makeWASocket(connectionOptions, options = {}) {
     ...
     */
    let conn;
    if (global.opts["legacy"] && typeof makeWALegacySocket === 'function') {
        conn = makeWALegacySocket(connectionOptions);
    } else if (typeof _makeWaSocket === 'function') {
        conn = _makeWaSocket(connectionOptions);
    } else {
        throw new Error("No se encontró una función válida para crear el socket de WhatsApp");
    }
